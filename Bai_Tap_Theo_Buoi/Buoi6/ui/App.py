...
import json 
import threading
from core.Algorithm import BFS1, BFS2, DFS, IDS
...
def UIPuzzle():
    ...
    grid_matrix = tk.Frame(puzzle_frame, bg="#E3F2FD")
    grid_matrix.grid(row = 1, column = 0)
    label_1 = tk.Label(grid_matrix, text = "1", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_2 = tk.Label(grid_matrix, text = "2", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_3 = tk.Label(grid_matrix, text = "3", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_4 = tk.Label(grid_matrix, text = "4", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_5 = tk.Label(grid_matrix, text = "5", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_6 = tk.Label(grid_matrix, text = "6", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_7 = tk.Label(grid_matrix, text = "7", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    label_8 = tk.Label(grid_matrix, text = "8", width = 6, height = 3, bd = 2, relief="ridge", bg = "#88BFEF", fg = "white", font=("Arial",14,"bold"))  
    ...
    nhap_label = tk.Label(ma_tran_frame, text = "Nhập ma trận mới ở đây: ", bg="white", fg="darkblue", font=("Arial",10,"bold"))
    ...
    btn_doi = tk.Button(ma_tran_frame, text = "Đổi", command = doi_ma_tran, bg="darkblue", fg="white")
    ...
    dashboard_frame = tk.Frame(main_frame, bg = "#E3F2FD", bd = 1, relief = "groove")
    dashboard_frame.grid(row = 0, column = 1, padx = 10, pady = 5, sticky = "nsew")
    #1. Thêm nhãn 
    bfs_label = tk.Label(dashboard_frame, text = "Chế độ: ", fg="#092F97", font=("Helvetica", 10, "bold"))
    bfs_label.grid(row = 0, column = 0, padx = 1, pady = 7, sticky = "nw")

    #2. Thêm Combo Box
    list_bfs = ["BFS1", "BFS2", "DFS", "IDS"]
    ...
    def run_solver(che_do):
        ...
        solvers = {"BFS1": BFS1, "BFS2": BFS2, "DFS": DFS, "IDS": IDS}
    ...
    btn_tam_dung = tk.Button(dashboard_frame, text = "Tạm dừng giải", command = tam_dung, bg="white", fg="#F59E0B", font=("Helvetica", 10, "bold"))
    btn_tam_dung.grid(row = 2, column = 0, columnspan = 2, padx = 3, pady = 7, sticky = "nsew")

    #5. Tốc độ giải: 
    label_toc_do = tk.Label(dashboard_frame, text = "  Tốc độ di: ", bg="white", fg="#6f42c1")
    ...
    btn_reset = tk.Button(dashboard_frame, text = "Reset", command = reset_UI, bg="white", fg="red", font=("Helvetica", 10, "bold"))
    ...
    #Độ sâu
    do_sau = tk.Label(thong_ke_frame, text = "Độ sâ: 0", bg="#E3F2FD")
    do_sau.pack(anchor = "w", padx = 3, pady = 3)

    #III. Thêm Log State:
    log_frame = tk.LabelFrame(root, text = "Log - State", fg="#4B0082", font=("Helvetica", 10, "bold"))
    ...
    label_duong_di = tk.Label(duong_di_frame, text = "Đường đi: ", fg="#00BFFF", font=("Helvetica", 10, "bold"))
