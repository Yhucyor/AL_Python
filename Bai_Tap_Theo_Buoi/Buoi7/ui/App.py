...
import json 
import threading
from core.Algorithm import BFS1, BFS2, DFS, IDS, UCS, Greedy_Search
...
def UIPuzzle():
    ...
    #2. Thêm Combo Box
    list_bfs = ["BFS1", "BFS2", "DFS", "IDS", "UCS", "Greedy_Search"]
    ...
    def run_solver(che_do):
        ...
        solvers = {"BFS1": BFS1, "BFS2": BFS2, "DFS": DFS, "IDS": IDS, "UCS": UCS, "Greedy_Search": Greedy_Search}
    ...
    #5. Tốc độ giải: 
    label_toc_do = tk.Label(dashboard_frame, text = "  Tốc độ đi: ", bg="white", fg="#6f42c1")
