...
import json 
import threading
from core.Algorithm import BFS1, BFS2, DFS, IDS, UCS, Greedy_Search, A_Start, IDA
...
def UIPuzzle():
    ...
    #2. Thêm Combo Box
    list_bfs = ["BFS1", "BFS2", "DFS", "IDS", "UCS", "Greedy_Search", "A_Start", "IDA"]
    ...
    def run_solver(che_do):
        ...
        solvers = {"BFS1": BFS1, "BFS2": BFS2, "DFS": DFS, "IDS": IDS, "UCS": UCS, "Greedy_Search": Greedy_Search, "A_Start": A_Start, "IDA": IDA}        
